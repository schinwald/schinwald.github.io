...
const Jumbotron: React.FC<JumbotronProps> = ({ className }) => {
  ...
  return (
    <div className='relative h-screen flex flex-col justify-center items-center gap-2 overflow-x-clip transition-all'>
      ...
      <nav className='absolute bottom-0 left-0 right-0 bg-background-overlay pt-8 pb-6 h-20 flex flex-row justify-center items-center gap-20 border-b border-b-8 border-[#fff2]'>
        ...
        <a className='font-display text-xl opacity-70' href='#testimonials'>Testimonials</a>
        <a className='font-display text-xl opacity-70' href='#contact'>Contact</a>
      </nav>
    </div>
  )
}
