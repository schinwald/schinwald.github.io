...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap font-display rounded-md ring-offset-background transition-colors disabled:pointer-events-none disabled:opacity-50 transition-transform duration-200 cursor-pointer",
  {
    variants: {
      variant: {
        default:
