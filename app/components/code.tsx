        ...
        <div className='grid'>
          <div className='col-span-full row-span-full px-5 py-4 flex items-start justify-end'>
            <div className='sticky top-4'>
              <Button variant='ghost' size='minimal' className='size-5' onClick={() => {
          ...
          <pre className='col-span-full row-span-full border-white rounded-md px-5 py-4 text-md' style={style}>
            {filename ?
              <div className='mb-4'>
