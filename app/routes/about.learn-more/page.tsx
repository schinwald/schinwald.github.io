											...
											<Card.Root>
												<article className="flex flex-col gap-6">
													...
													<p>
														...
														New York, alongside my twin brother. My earliest
														years were spent in Red Hook, NY, before our family
														embarked on a unique adventure, living in Honduras
														and Nicaragua for a year and then moving to Buenos
														Aires, Argentina, for four years. My dad’s work at
														Tiempos del Mundo, an international newspaper,
														brought us to South America, where I had my first
														exposure to a different culture and language. I
														quickly picked up Spanish and embraced the local
														love of soccer. Watching Lionel Messi dominate
														headlines and pitches inspired me to play soccer as
														much as I could.
													</p>
													<p>
														When we returned to Canada, we settled in Guelph,
														Ontario, where I’ve lived ever since. Thanks to
														speaking English at home and my mom’s French
														Canadian heritage, the transition felt natural.
														School life was a blend of creativity and
														independence for me. I spent hours practicing ping
														pong against a flipped-up table or shooting hoops at
														our basketball net, often playing by myself. Video
														games became another outlet, though sharing one
														computer with my two brothers led to plenty of
														fights over whose turn it was—especially during
														World of Warcraft raids. I also had a strong passion
														for art and once dreamed of becoming an animator,
														filling sketchbooks with drawings as I imagined a
														creative future.
													</p>
													<p>
														High school introduced me to programming through
														basic classes in web development and Java, but these
													...
													<p>
														...
														determination to find a career I was passionate
														about.
													</p>
													<p>
														Eventually, I committed to software engineering,
														driven by my love for programming and the desire to
														understand the technology I use daily. I enrolled in
														a computer science program and quickly discovered my
														passion for web development, scalable applications,
														and even game development. I’m also deeply
														interested in creating streamlined development
														environments that enhance productivity and
														creativity.
													</p>
													<p>
														Looking back, the journey—from my global upbringing
														to odd jobs and self-discovery—has shaped who I am
														today. I’m grateful for the experiences that brought
														me to a career I truly love.
													</p>
												</article>
											</Card.Root>
										</div>
														...
														<Dictionary.Root>
															...
															<Dictionary.Explanation>
																<p className="text-white text-sm">
																	A soldering iron tip that can be powered by a
																	DC input voltage between 12V-24V, via a 5.5mm
																	barrel connector.
																</p>
															</Dictionary.Explanation>
														</Dictionary.Root>{" "}
										...
										<div className="col-span-2 row-span-2">
											<Card.Root>
												<div className="flex flex-col gap-6">
													...
													<p>
														I think this stems from my love for making stuff,
														but recently I've been taking up woodworking and
														have really been enjoying it. I made my{" "}
														<a className="text-primary" href="/">
															desk
														</a>{" "}
														out of a birch vaneer plywood and applied a
														polyurethane coating to protect it from coffee
														spills.
													</p>
												</div>
											</Card.Root>
											...
											<Card.Root>
												<div className="flex flex-col gap-6">
													...
													<p>
														...
														experience portaging through Algonquin Park for
														weeks on end. Now days, I do more ✨glamping✨, but
														I would love to get back to more serious camping
														soon.
													</p>
												</div>
											</Card.Root>
											...
											<Card.Root>
												<div className="flex flex-col gap-6">
													...
													<p>
														...
														techniques and would often post my creations on
														forums for people to critique. To this day, I still
														get a lot of joy from a jaw dropping animation. I
														think that's why I enjoy watching{" "}
														<Dictionary.Root>
															...
															<Dictionary.Explanation>
																<p className="text-sm">
																	...
																	animations in anime production, but the
																	western population has morphed the meaning to
																	represent{" "}
										...
										<div className="col-span-2">
											<Card.Root>
												<div className="flex flex-col gap-6">
													...
													<p>
														I strive to make open source contributions to
														projects that I use. One day I would love to be the
														core maintainer of my own open source project.
													</p>
												</div>
											</Card.Root>
										</div>
											...
											<Card.Root>
												<div className="flex flex-col gap-6">
													...
													<p>
														...
														split layout, as it allows me to have a more
										...
										<div className="col-span-2">
											<Card.Root>
												<div className="flex flex-col gap-6">
													<h3>Neovim</h3>
													<p>
														My editor of choice is Neovim. I've been using it
														for a while now, and I'm really loving it. It's
														fast, it's extensible, and it's just the best editor
														I've ever used (despite what the haters think!).
													</p>
												</div>
											</Card.Root>
										</div>
										<div className="col-span-2 row-span-2">
											<Card.Root>
												<div className="flex flex-col gap-6">
													<h3>Obsidian</h3>
													<p>
														I never really grew up taking notes, but Obsidian
														has made note-taking a breeze.
													</p>
												</div>
											</Card.Root>
										</div>
