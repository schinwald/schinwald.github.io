...
export const Background = () => (
  ...
  >
    <div className='bg-gradient-to-r from-transparent to-background-soft w-[100px] h-full'></div>
    <div className='bg-background-soft w-full max-w-screen-md h-full'></div>
    <div className='bg-gradient-to-r from-background-soft to-transparent w-[100px] h-full'></div>
  </div>
)
